...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"KittVoiceCommandInput", {CLEAR_ON_MANAGER_START | DONT_LOG, STRING}},
    ...
    {"KittTrafficFusionLastState", {PERSISTENT | DONT_LOG, JSON}},
    {"KittTrafficLastCamera", {PERSISTENT | DONT_LOG, STRING}},
    {"KittTrafficLastState", {PERSISTENT | DONT_LOG, JSON}},
    {"KittTrafficState", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION | DONT_LOG, JSON}},
